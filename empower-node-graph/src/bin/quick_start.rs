...
fn main()
{
    ...
    let start_node_type = empower_node_graph::NodeType::IntegerVariable;
    // let print_node_type = empower_node_graph::NodeType::Print;

    let start_node_key = node_graph.add_node(start_node_type);
    ...
    // node_graph.add_connection(node_2_input_port_keys[0], node_1_output_port_keys[0]);
