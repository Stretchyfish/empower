use empower_engine::node_graph::node::{NodeKind, node_kind::{FilePathState, MathGraphState, NumberNodeState, VectorState}};
    ...
    {                    
        ...
        .show(ui, |ui| 
        {
            ui.group(|ui|
            {
                ...
                {
                    let new_node_type = NodeKind::ShowImage;
                    graph_editor.add_node(new_node_type, *mouse_position_in_scene);
                ...
                {
                    let new_node_type = NodeKind::MathGraph(MathGraphState::new());
                    graph_editor.add_node(new_node_type, *mouse_position_in_scene);
