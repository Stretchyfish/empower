use egui::Options;
use empower_node_graph::{port, EmpowerData, EmpowerKey};
...
pub fn show_connection_search(ui: &mut egui::Ui, graph_editor: &mut GraphEditor, port_searcher: Option<PortSearcher>, mouse_scene_position: &egui::Pos2)
{
    ...
    ui.painter().line_segment([ display_port_position, *mouse_scene_position], egui::Stroke::new(10.0, search_color));
}
