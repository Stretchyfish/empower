...
pub fn view_node_selector(node_selection_panel_state: &mut NodeSelectionPanelState, studio_context: &mut StudioContext, ui: &mut egui::Ui, user_input: &interactions::user::UserInputs, mouse_position_in_scene: &egui::Pos2)
{
        ...
        .show(ui, |ui| 
        {
            ui.group(|ui|
            {
                ...
                {                                        
                    ...
                    studio_context.add_node(new_node_type, *mouse_position_in_scene );
                    // studio_context.add_node( egui::Pos2::new(mouse_position_in_scene.x, mouse_position_in_scene.y) );
                ...
                if ui.add(egui::Button::new("int add value").min_size(egui::Vec2 {x: 190.0, y: 20.0})).clicked() // @TODO, get rid of these hard coded values (if possible?)
                {
                    ...
                    studio_context.add_node(new_node_type, egui::Pos2::default());
