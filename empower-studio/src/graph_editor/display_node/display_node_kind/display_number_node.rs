...
use empower_engine::node_graph::node::node_kind::number_node::NumberNode;
...
pub fn get_display_number_node_size() -> egui::Vec2
{
    egui::Vec2 { x: 450.0, y: 165.0 }
}

pub fn get_display_number_node_input_ports(inputs: Vec<&PortValue>) -> Vec<DisplayPortValue>
{
    vec![ 
        DisplayPortValue::from("in".to_string(), inputs[0]),
    ]
