...
pub struct AreaSelect
{
    ...
    pub rect: egui::Rect,
    pub nodes_inside_rect: HashSet<NodeGraphKey>, // @TODO, change this to public once graph viewport is updated
}
...
impl AreaSelect
{
        ...
        fn add_node_to_nodes_inside_of_rect(&mut self, node_key: &NodeGraphKey)
    {
        ...
        self.nodes_inside_rect.insert( *node_key );
    }
